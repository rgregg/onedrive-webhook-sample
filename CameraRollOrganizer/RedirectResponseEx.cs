...
{
    internal class RedirectResponseEx : IHttpActionResult
    {
        ...
        {
            return new RedirectResponseEx(location, cookie);
        }

        public RedirectResponseEx(string location, CookieHeaderValue cookie = null)
        {
            _location = location;
            _cookie = cookie;
        }
